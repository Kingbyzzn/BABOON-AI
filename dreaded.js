...
const antibot = process.env.ANTIBOT || 'FALSE';
    ...
    const author = process.env.STICKER_AUTHOR ||'𝐁𝐀𝐁𝐎𝐎𝐍-𝐀𝐈';
    const packname = process.env.STICKER_PACKNAME || '𝐁𝐀𝐁𝐎𝐎𝐍';
...
const admin = process.env.ADMIN_MSG || '𝐇𝐮𝐡!\n𝐀𝐝𝐦𝐢𝐦𝐬 𝐨𝐧𝐥𝐲, 𝐃𝐮𝐦𝐦𝐲.';
    ...
    const NotOwner = process.env.NOT_OWNER_MSG || '𝐁𝐀𝐁𝐎𝐎𝐍 𝐎𝐍𝐋𝐘 ☬';
...
"《 ██████████▒▒》80%",
"《 ████████████》100%",
"	✦𝐋𝐨𝐚𝐝𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥 𝐛𝐲 𝐁𝐀𝐁𝐎𝐎𝐍! ☫"
]
let { key } = await client.sendMessage(from, {text: '𝐋𝐨𝐚𝐝𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥 𝐛𝐲 𝐁𝐀𝐁𝐎𝐎𝐍! ☬...'})
...
┃⚠️┏━━━━━━━━━━━━━━━┛
┃⚠️┃ 𝗢𝘄𝗻𝗲𝗿 : ☣️𝐋𝐔𝐂𝐀𝐒☣️
┃⚠️┃ 𝗨𝘀𝗲𝗿 : ${m.pushName}︎︎
┃⚠️┃ 𝗥𝘂𝗻𝘁𝗶𝗺𝗲 :${runtime(process.uptime())}
┃⚠️┃ 𝗣𝗹𝗮𝘁𝗳𝗼𝗿𝗺 : 𝐋𝐢𝐧𝐮𝐱
┃⚠️┃ 𝗥𝗮𝗺 : 64GB of 256GB
┃⚠️┃ 𝐕𝐞𝐫𝐬𝐢𝐨𝐧: 𝐯𝟏.𝟎.𝟏
┃⚠️┃ 𝗣𝗿𝗲𝗳𝗶𝘅 : ${prefix}
┃⚠️┃ 𝗦𝗽𝗲𝗲𝗱 :  *${dreadedspeed.toFixed(4)}* 𝐌𝐬
┃⚠️┃
┃⚠️┃ ▎▍▌▌▉▏▎▌▉▐▏▌
┃⚠️┃┃▎▍▌▌▉▏▎▌▉▐▏▌
┃⚠️┃ 
...
client.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnail: fs.readFileSync('./𝐁𝐚𝐛𝐨𝐨𝐧_𝐋𝐮𝐜𝐚𝐬_𝐀𝐈.jpg'),
...
await m.reply('𝐑𝐞𝐦𝐨𝐯𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐛𝐲 𝐁𝐀𝐁𝐎𝐎𝐍☬'); 
} catch (errr) { 
        ...
        try {
            ...
            if (fileSizeInMegabytes <= 100) {
                client.sendMessage(
                    from, {
                        video: fs.readFileSync(`./${randomName}`),
                        caption: `𝐆𝐞𝐧𝐞𝐫𝐚𝐭𝐞𝐝 𝐛𝐲 𝐁𝐀𝐁𝐎𝐎𝐍-𝐀𝐈`,
                    }, {
                        quoted: m
                    }
                );
...
case "ping": case "speed": { 
 ...
 case "runtime": { 
                 m.reply (`𝐁𝐀𝐁𝐎𝐎𝐍 𝐀𝐈 𝙷𝚊𝚜 𝙱𝚎𝚎𝚗 𝙰𝚌𝚝𝚒𝚟𝚎 𝙵𝚘𝚛 ${runtime(process.uptime())}`) 
 } 
 break;
...
const audiovn = "./Baboon.mp3";
    const dooc = {
        ...
        contextInfo: {
          ...
          externalAdReply: {
          title: "𝐇𝐢 𝐇𝐮𝐦𝐚𝐧,𝐁𝐀𝐁𝐎𝐎𝐍 𝐁𝐎𝐓 𝐈𝐬 𝐀𝐥𝐢𝐯𝐞 𝐚𝐧𝐝 𝐊𝐢𝐜𝐤𝐢𝐧𝐠",
...
break;
 ...
 break 
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `*𝐂𝐨𝐧𝐯𝐞𝐫𝐭𝐞𝐝 𝐛𝐲 𝐁𝐀𝐁𝐎𝐎𝐍 ☬*`}, { quoted: m }) 
...
case "movie": 
 ...
 client.sendMessage(m.chat, { video: { url: 'https://a.uguu.se/qWrDNxhB.mp4' }, caption: `𝐇𝐞𝐫𝐞 𝐢𝐬 𝐦𝐲 𝐚𝐧𝐨𝐧𝐲𝐦𝐨𝐮𝐬 𝐜𝐫𝐞𝐚𝐭𝐨𝐫, +254741188211 ☤☬` }, {quoted: m}); 
